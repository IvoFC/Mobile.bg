(function () {
    ...
    viewPublicationButton.addEventListener('click', function (event) {
        ...
        for (var index = 0; index < radioButtons.length; index++) {
            document.getElementById("previewSelections").innerHTML += radioButtons[index].value + "<br/>";
        }
        ...
        for (var index = 0; index < checkBoxes.length; index++) {
            document.getElementById("previewSelections").innerHTML += checkBoxes[index].value + "<br/>";
        }
